...
class Glm4MoeLiteSharedHead(nn.Module):
    def __init__(self, config: Glm4MoeLiteConfig):
        super().__init__()
...
class Glm4MoeLiteMultiTokenPredictorLayer(Glm4MoeLiteDecoderLayer):
    def __init__(self, config: Glm4MoeLiteConfig, layer_idx: int):
        ...
        self.shared_head = Glm4MoeLiteSharedHead(config)
...
class Glm4MoeLiteModel(Glm4MoeLitePreTrainedModel):
    def __init__(self, config: Glm4MoeLiteConfig):
        ...
        self.layers.extend(
            [
                Glm4MoeLiteMultiTokenPredictorLayer(config, layer_idx)
...
class Glm4MoeLiteCausalLMOutputWithPast(ModelOutput):
    r"""
...
class Glm4MoeLiteForCausalLM(Glm4MoeLitePreTrainedModel, GenerationMixin):
    ...
    def forward(
        ...
        **kwargs: Unpack[TransformersKwargs],
    ) -> Glm4MoeLiteCausalLMOutputWithPast:
        r"""
        ...
        return Glm4MoeLiteCausalLMOutputWithPast(
            loss=loss,
            logits=logits,
