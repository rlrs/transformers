...
class SolarOpenSharedHead(nn.Module):
    def __init__(self, config: SolarOpenConfig):
        super().__init__()
...
class SolarOpenMultiTokenPredictorLayer(SolarOpenDecoderLayer):
    def __init__(self, config: SolarOpenConfig, layer_idx: int):
        ...
        self.shared_head = SolarOpenSharedHead(config)
...
class SolarOpenModel(SolarOpenPreTrainedModel):
    def __init__(self, config: SolarOpenConfig):
        ...
        self.layers.extend(
            [
                SolarOpenMultiTokenPredictorLayer(config, layer_idx)
...
class SolarOpenCausalLMOutputWithPast(ModelOutput):
    r"""
...
class SolarOpenForCausalLM(SolarOpenPreTrainedModel, GenerationMixin):
    ...
    def forward(
        ...
        **kwargs: Unpack[TransformersKwargs],
    ) -> SolarOpenCausalLMOutputWithPast:
        r"""
        ...
        return SolarOpenCausalLMOutputWithPast(
            loss=loss,
            logits=logits,
